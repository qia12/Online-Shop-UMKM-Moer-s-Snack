        ...
        <div class="col-md-10 mx-auto" style="margin-top: 30px;">
            <div style="padding: 10px;">
                <button type="button" id="btnOpenForm" class="btn btn-primary">
                    <a href="<?= base_url('review/create') ?>"><i class="fa fa-plus" style="color:aliceblue"> Tambah</i></a>
                </button>
            </div>
            <div class="card mb-3">
                            ...
                            <tbody>
                                ...
                                foreach ($content as $row) :  $no++; ?>
                                    <tr>
                                        ...
                                        <td style="width: 30px;"><?= $row->domicile ?></td>
                                        <td style="width: 30px;">
                                        ...
                                        <td>
                                            <div class="row g-2 align-items-center">
                                                <div class="col-6 col-sm-4 col-md-2 col-xl-auto mb-1">
                                                    <?= form_open("review/delete/$row->id", ['method' => 'POST']) ?>
                                                    <?= form_hidden('id', $row->id) ?>
                                                    <a href="<?= base_url("review/edit/$row->id") ?>" class="btn w-10 btn-icon btn-outline-success btn-edit-store" data-toggle="tooltip" data-placement="top" title="Edit Data">
