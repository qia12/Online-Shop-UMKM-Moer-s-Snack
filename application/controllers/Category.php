...
class Category extends MY_Controller
{
    ...
    public function index($page = null)
    {
        ...
        $this->category->table    = 'product';
        $data['product']    = $this->category->select(
            [
                'product.id', 'product.title AS product_title', 'product.image',
                'product.price', 'product.is_available', 'product.stock', 'product.weight',
    ...
    public function check_associated_products($category_id)
    {
        $hasAssociatedProducts = $this->category->hasAssociatedProducts($category_id);
        header('Content-Type: application/json');
        echo json_encode(['hasAssociatedProducts' => $hasAssociatedProducts]);
    }
}
